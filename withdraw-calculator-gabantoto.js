// ==UserScript==
// @name         withdraw_calculator_gabantoto
// @namespace    http://tampermonkey.net/
// @version      1.5
// @description  Menghitung total withdraw dan klasifikasi bank secara otomatis dengan warna kustom.
// @author       Gemini
// @match        *://*.cocatoto.org/mimin/withdraw-requests*
// @match        *://cocatoto.org/mimin/withdraw-requests*
// @run-at       document-end
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    function initScript() {
        ...
        const getBankStyle = (bankName) => {
            ...
            // Default style untuk bank lainnya (Abu-abu elegan)
        ...
        // 3. Pasang panel dengan fallback selector
        ...
        const calculateData = async () => {
            ...
            let html = `
                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                    <h5 class="text-secondary mb-0 fw-bold">Total Keseluruhan (${grandTotalCount} Request)</h5>
                    <h3 class="text-dark mb-0 fw-bolder">${formatRp(grandTotalAmount)}</h3>
                </div>
                <div class="row g-3">
            `;
        ...
        calculateData();
        document.getElementById('btn-refresh-wd').addEventListener('click', calculateData);
    }
